...
public class CubeRenderer implements GLSurfaceView.Renderer {
    ...
    public void operationAnimation(GL10 gl, int index, int rotatedLayer) {
        ...
        switch (rotatedLayer) {
            ...
            case Cube.front:
                if (condition(index, Cube.front)) gl.glRotatef(angleOperation, 0.0f, 0.0f, -1.0f);
                break;
            case Cube.back:
                if (condition(index, Cube.back)) gl.glRotatef(angleOperation, 0.0f, 0.0f, 1.0f);
                break;
            case Cube.right:
                if (condition(index, Cube.right)) gl.glRotatef(angleOperation, -1.0f, 0.0f, 0.0f);
                break;
            case Cube.left:
                if (condition(index, Cube.left)) gl.glRotatef(angleOperation, 1.0f, 0.0f, 0.0f);
                break;
            case Cube.up:
                if (condition(index, Cube.up)) gl.glRotatef(angleOperation, 0.0f, -1.0f, 0.0f);
                break;
            case Cube.down:
                if (condition(index, Cube.down)) gl.glRotatef(angleOperation, 0.0f, 1.0f, 0.0f);
                break;
            case Cube.slide:
                if (condition(index, Cube.slide)) gl.glRotatef(angleOperation, 0.0f, 0.0f, -1.0f);
                break;
            case Cube.middle:
                if (condition(index, Cube.middle)) gl.glRotatef(angleOperation, 1.0f, 0.0f, 0.0f);
                break;
            case Cube.equator:
                if (condition(index, Cube.equator)) gl.glRotatef(angleOperation, 0.0f, 1.0f, 0.0f);
                break;

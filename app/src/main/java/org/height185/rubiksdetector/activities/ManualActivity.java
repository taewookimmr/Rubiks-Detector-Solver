    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (imageOrder) {
                    case 0:
                        imageView_manual.setImageResource(R.drawable.manual_front);
                        break;
                    case 1:
                        imageView_manual.setImageResource(R.drawable.manual_right);
                        break;
                    case 2:
                        imageView_manual.setImageResource(R.drawable.manual_back);
                        break;
                    case 3:
                        imageView_manual.setImageResource(R.drawable.manual_left);
                        break;
                    case 4:
                        imageView_manual.setImageResource(R.drawable.manual_up);
                        break;
                }
            ...
            public void onClick(View v) {
                ...
                switch (imageOrder) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        imageView_manual.setImageResource(R.drawable.manual_down);
                        break;
                }
